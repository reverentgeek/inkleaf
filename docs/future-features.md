...
- [ ] Add UI to create new notebooks (currently hardcoded in `Sidebar.tsx:7`)
- [ ] Add notebook picker to the editor so notes can be moved between notebooks
- [ ] Add ability to rename and delete notebooks
